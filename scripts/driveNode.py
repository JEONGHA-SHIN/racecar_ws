...
class driveStop(object):
	...
	def __init__(self):
		...
		self.image_sub = rospy.Subscriber('/teachable_machine', Float32MultiArray, self.machine_learning_callback)
	...
	def driveStop_car_callback(self,data):
		...
		#cv_numpy = np.array(data)
		#print(len(cv_numpy))
		#cv_image = cv_numpy.reshape(480, 640, 3, order='C')
